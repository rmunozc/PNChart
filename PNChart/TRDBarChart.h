...
@property (nonatomic, retain) id<TRDChartDelegate> delegate;

/* add to Simple Project */
@property (nonatomic) UIColor *chartBorderColor;
@property (nonatomic) CGFloat borderLineWidth;
@property (copy) NSArray *alternativeXLabels;
@property (nonatomic) UIColor *alternativeBackgroundColor;
